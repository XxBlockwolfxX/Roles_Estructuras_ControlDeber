...
namespace Roles_Estructuras_Control.Controllers
{
    public class DetalleFacturaController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StockModelsId"] = new SelectList(_context.Stock, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Cantidad,Valor,ProductoModelsId,FacturaModelId,StockModelsId")] DetalleFacturaModel detalleFacturaModel)
        {
            ...
            ViewData["ProductoModelsId"] = new SelectList(_context.Productos, "Id", "Id", detalleFacturaModel.ProductoModelsId);
            ViewData["StockModelsId"] = new SelectList(_context.Stock, "Id", "Id", detalleFacturaModel.StockModelsId);
            return View(detalleFacturaModel);
        }
